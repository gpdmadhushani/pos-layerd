...
public class ItemServiceImpl implements ItemService {
    ...
    public String addItem(ItemDto dto) throws Exception {
      if(itemDao.add(new ItemEntity(dto.getItemCode(),dto.getDescription(),dto.getPackSize(),dto.getUnitPrice(),dto.getQoh()))){
    ...
    public String updateItem(ItemDto dto) throws Exception {
      if(itemDao.update(new ItemEntity(dto.getItemCode(),dto.getDescription(),dto.getPackSize(),dto.getUnitPrice(),dto.getQoh()))){
    ...
    public ItemDto getItem(String id) throws Exception {
        ...
        return new ItemDto(entity.getItemCode(),entity.getDescription(),entity.getPackSize(),entity.getUnitPrice(),entity.getQoh());
    }
    ...
    for(ItemEntity entity:itemEntitys ){
        ItemDto dto=new ItemDto(entity.getItemCode(), entity.getDescription(), entity.getPackSize(), entity.getUnitPrice(), entity.getQoh());
        itemDtos.add(dto);
